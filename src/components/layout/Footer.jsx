...
const Footer = () => {
  return (
    <footer className="bg-[#050505] py-12 border-t border-white/5 text-center px-6">
      <div className="flex justify-center gap-6 mb-8">
        <a href="#" className="text-neutral-500 hover:text-white transition-colors"><GithubIcon size={20} /></a>
        <a href="#" className="text-neutral-500 hover:text-white transition-colors"><DribbbleIcon size={20} /></a>
