...
const ContactView = () => {
  ...
  return (
    <PageTransition className="pt-32 pb-20 px-6 flex justify-center relative">
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center my-auto">
        
        <div>
          <div className="overflow-hidden mb-6 text-center lg:text-left">
          ...
          <motion.p variants={fadeUp} className="text-lg text-gray-400 font-light mb-12 max-w-md mx-auto lg:mx-0 text-center lg:text-left">
            Whether it's a job opportunity, a freelance project, or just to talk tech, my inbox is always open.
          </motion.p>
          <motion.div variants={fadeUp} className="space-y-6 flex flex-col items-center lg:items-start">
        ...
        <motion.div variants={fadeUp} className="bg-zinc-900/50 backdrop-blur-xl border border-white/5 p-8 md:p-12 rounded-[2rem] relative overflow-hidden">
